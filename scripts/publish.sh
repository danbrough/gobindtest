...
echo running GOPROXY=proxy.golang.org go list -m  github.com/danbrough/gobindtest@$VERSION_NAME
GOPROXY=proxy.golang.org go list -m  github.com/danbrough/gobindtest@$VERSION_NAME
